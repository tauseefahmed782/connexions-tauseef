...
import AppleBusinessEnterpriseGridImg1 from "@/public/assets/appleswitch1.svg";
import AppleBusinessEnterpriseGridImg2 from "@/public/assets/apple-business-grid-img-2.svg";
import AppleBusinessEnterpriseGridImg3 from "@/public/assets/appleswitch2.svg";

import CommonImage from "../common/CommonImage";

const AppleSwitchGrid = () => {
  return (
    <div className="flex flex-col gap-6 sm:gap-8 py-8 sm:py-10 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-30 bg-white mb-10">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center gap-6 sm:gap-8 lg:gap-12">
        ...
        <div className="flex flex-col gap-3 sm:gap-4 w-full lg:w-[600px] text-center lg:text-left">
          <h2 className="text-primary text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
           Personalized Migration & Zero-Touch Deployment
          </h2>
          <p className="text-[#4B5563] text-sm sm:text-base md:text-lg leading-relaxed">
            We provide tailored data, app, and settings migration with minimal disruption, plus leverage Apple Business Manager and MDM for effortless zero-touch setups
          </p>
      ...
      <div className="flex flex-col lg:flex-row-reverse justify-between items-center gap-6 sm:gap-8 lg:gap-12">
        ...
        <div className="flex flex-col gap-3 sm:gap-4 w-full lg:w-[600px] text-center lg:text-left">
          <h2 className="text-primary text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
           App Readiness & Training
          </h2>
          <p className="text-[#4B5563] text-sm sm:text-base md:text-lg leading-relaxed">
           Assess your environment for full macOS compatibility, with comprehensive employee training and IT enablement for users and admins.
Explore Service
            </p>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center gap-6 sm:gap-8 lg:gap-12">
        ...
        <div className="flex flex-col gap-3 sm:gap-4 w-full lg:w-[600px] text-center lg:text-left">
          ...
          <p className="text-[#4B5563] text-sm sm:text-base md:text-lg leading-relaxed">
            Access trade-in, leasing, and lifecycle management through Apple Financial Services for cost-effective scaling.
          </p>
...
export default AppleSwitchGrid;
