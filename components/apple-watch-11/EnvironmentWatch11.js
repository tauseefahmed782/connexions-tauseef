  ...
  const cards = [
    {
      ...
      text: (
        <span className="font-bold text-lg md:text-xl lg:text-2xl tracking-[0.2px]">
          Made with{" "}
          <span className="text-[#8668FF]">40% recycled material</span> by
          weight.
        </span>
      ),
    },
    {
      ...
      text: (
        <span className="font-bold text-lg md:text-xl lg:text-2xl tracking-[0.2px]">
          Manufactured with{" "}
          <span className="text-[#ED6300]">100% renewable electricity.</span>
        </span>
      ),
    },
    {
      ...
      text: (
        <span className="font-bold text-lg md:text-xl lg:text-2xl tracking-[0.2px]">
          ...
          <span className="text-[#00A1B3]">40% more units</span> per trip.
        </span>
      ),
    },
  ];
  ...
  return (
    <section className="bg-white py-16 px-4 sm:px-6 lg:px-30">
      ...
      <h2 className="text-primary text-3xl md:text-4xl lg:text-5xl font-bold text-lleft mb-12">
        Apple Watch 11 <br /> and the environment.
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
        {cards.map((card, idx) => (
          <div
            key={idx}
            className="flex flex-col items-start gap-4 px-4 border border-[#F1F1F1] rounded-2xl p-4 min-h-[300px]"
          >
            <CommonImage
...
export default EnvironmentWatch11;
