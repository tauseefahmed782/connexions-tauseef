...
import BannerImg from "@/public/assets/apple-airpods-banner-img.svg";
  ...
  return (
    <div>
      ...
      <div className="bg-[#F5F5F7] flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 p-3 sm:p-2">
        ...
        <span className="font-normal text-xs sm:text-sm tracking-[-0.22px] text-[#A6CE39] cursor-pointer hover:underline">
          <a href="/contact-us" className="flex items-center gap-1">
