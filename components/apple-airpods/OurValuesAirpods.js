...
const OurValuesAirpods = () => {
  ...
  return (
    <section className="bg-[#F5F5F7] py-16 px-4 sm:px-6 lg:px-30">
      {/* Section Heading */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 max-w-6xl mx-auto">
        {cards.map((card, idx) => (
          <div
            key={idx}
            className="flex flex-col items-start gap-4 py-4 px-6 bg-white min-h-[300px] rounded-3xl"
          >
            <CommonImage
            ...
            <div className="text-left">
              ...
              <p className="text-primary text-sm md:text-base font-normal tracking-[-0.37px] mt-2">
                {card.description}
              </p>
...
export default OurValuesAirpods;
