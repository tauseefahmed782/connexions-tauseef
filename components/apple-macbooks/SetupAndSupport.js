...
import SetupSupportImg1 from "@/public/assets/apple-macbook-setup-support-img-1.svg";
import SetupSupportImg2 from "@/public/assets/apple-macbook-setup-support-img-2.svg";
import SetupSupportImg3 from "@/public/assets/apple-macbook-setup-support-img-3.svg";
...
// Card Component
const SetupSupportCard = ({ image, alt }) => {
  return (
          ...
          >
            {cardsData.map((card, index) => (
              <SwiperSlide key={index} className="h-auto flex">
                <SetupSupportCard image={card.image} alt={card.alt} />
              </SwiperSlide>
            ))}
          </Swiper>
