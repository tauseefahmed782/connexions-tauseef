...
export default function IphoneDuoContent() {
  ...
  return (
    <section aria-label="iPhone Duo" className="bg-black">
      <h1 className="sr-only">iPhone Duo</h1>
      <iframe
        ref={frameRef}
        src="/assets/iphone-duo/index.html"
        title="iPhone Duo features and comparison"
